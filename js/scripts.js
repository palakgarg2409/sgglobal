...
const abfront = document.getElementsByClassName("ab-front")[0];
const utfront = document.getElementsByClassName("ut-front")[0];
const abback = document.getElementsByClassName("ab-back")[0];
const utback = document.getElementsByClassName("ut-back")[0];
...
window.addEventListener("load", function(){
    ...
    let abfrontW = abfront.offsetWidth;
    let utfrontW = utfront.offsetWidth;
    let abbackW = abback.offsetWidth;
    let utbackW = utback.offsetWidth;
    abfront.style.left = (logobackL - abfrontW) + "px";
    utfront.style.left = (logobackL + utfrontW) + "px";
    abback.style.left = (logobackL - abbackW) + "px";
    utback.style.left = (logobackL + utbackW) + "px";
})
...
window.addEventListener("resize", function(){
    ...
    let abbackW = abback.offsetWidth;
    let utbackW = utback.offsetWidth;
    abfront.style.left = logobackL - abfrontW;
    utfront.style.left = logobackL + utfrontW;
    abback.style.left = logobackL - abbackW;
    utback.style.left = logobackL + utbackW;
})